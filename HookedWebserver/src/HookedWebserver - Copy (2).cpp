    ...
    if (STARTS(P,"/v2")) {
        ...
        if (STARTS(sub,"/universes")) {
            ...
            if (P.find("/configuration")!=std::string::npos) {
                /* PATCH — persist name/description changes */
                if (M == "PATCH" || M == "PUT") {
                ...
                if (!univId2.empty() && LoadUniverseJson(univId2, saved)) {
                    std::string uname = CfgStr(saved, "name");
                    char buf[1024]; _snprintf(buf,sizeof(buf)-1,
                        "{\"allowPrivateServers\":true,\"privateServerPrice\":null,"
                        "\"id\":%s,\"name\":\"%s\","
                        ...
                        "\"isArchived\":false,\"isFriendsOnly\":false,"
                        "\"genre\":\"All\","
                        "\"playableDevices\":[\"Computer\",\"Phone\",\"Tablet\"],"
                        "\"isForSale\":false,\"price\":0,"
                        "\"isStudioAccessToApisAllowed\":true,"
                        "\"privacyType\":\"Public\"}", univId2.c_str(), uname.c_str());
                    return RJson(buf);
                }
                return RJson("{\"allowPrivateServers\":true,\"privateServerPrice\":null,"
                    "\"id\":9991912465,\"name\":\"Baseplate\","
                    "\"universeAvatarType\":\"MorphToR15\","
                    "\"universeScaleType\":\"AllScales\","
                    "\"universeAnimationType\":\"PlayerChoice\","
                    "\"universeCollisionType\":\"OuterBox\","
 ...
 if (sub.find("/details") != std::string::npos) {
    ...
    if (STARTS(P,"/v1.")) {
        if (P.find("/avatar-fetch")!=std::string::npos ||
            ...
            return RJson("{\"resolvedAvatarType\":\"R6\","
                "\"equippedGearVersionIds\":[],"
                "\"backAccessoryVersionIds\":[],"
    ...
    return RJson("{\"previousPageCursor\":null,\"nextPageCursor\":null,\"data\":[" + savedItems + "]}");
        ...
        if (STARTS(sub,"/universes")) {
            ...
            if (P.find("/configuration")!=std::string::npos) {
                ...
                std::string saved;
                if (!univId.empty() && LoadUniverseJson(univId, saved)) {
                    /* Wrap the saved universe JSON as a configuration response */
                    std::string uname = CfgStr(saved, "name");
                    char buf[1024]; _snprintf(buf,sizeof(buf)-1,
                        "{\"allowPrivateServers\":true,\"privateServerPrice\":null,"
                        "\"id\":%s,\"name\":\"%s\","
                        ...
                        "\"isForSale\":false,\"price\":0,"
                        "\"isStudioAccessToApisAllowed\":true,"
                        "\"privacyType\":\"Public\"}", univId.c_str(), uname.c_str());
                    return RJson(buf);
                }
                return RJson("{\"allowPrivateServers\":true,\"privateServerPrice\":null,"
                    "\"id\":9991912465,\"name\":\"Baseplate\","
