...
/* Replace a JSON string or number field value in-place.
 * Handles both:  "key":"oldvalue"  (string — replaces between the quotes)
 *            and "key":12345       (number — replaces up to next , or })
 * Only replaces the first occurrence. */
static std::string JsonPatchField(const std::string& json,
                                  const char* key,
                                  ...
                                  bool isString)
{
    ...
    size_t vstart = p + k.size();
    while (vstart < json.size() && (json[vstart]==' '||json[vstart]=='\t')) vstart++;
    if (vstart >= json.size()) return json;
    size_t vend;
    if (isString) {
        if (json[vstart] != '"') return json;
        vstart++; /* skip opening quote */
        vend = vstart;
        while (vend < json.size() && json[vend] != '"') {
            if (json[vend] == '\\') vend++; /* skip escaped char */
            vend++;
        }
        /* vstart..vend is the content between quotes */
        std::string result = json.substr(0, vstart) + newVal + json.substr(vend);
        return result;
    } else {
        vend = vstart;
        while (vend < json.size() && json[vend] != ',' && json[vend] != '}') vend++;
        std::string result = json.substr(0, vstart) + newVal + json.substr(vend);
        return result;
    }
}
...
static bool LoadUniverseJson(const std::string& universeId, std::string& out)
{
    ...
    /* Always stamp our own userId/username as the creator so that games
     * saved under a different account still show us as owner. */
    raw = JsonPatchField(raw, "creatorTargetId", g_userId,   false);
    raw = JsonPatchField(raw, "creatorName",     g_username, true);
    raw = JsonPatchField(raw, "creatorId",       g_userId,   false);
    out = raw;
    return true;
}
 ...
 if (sub.find("/details") != std::string::npos) {
     ...
     * (universes, teamcreate, gametemplates, datastore, etc.) keep priority. */
    {
        ...
        if (STARTS(P,"/doc-site/v2/feeds"))
            return RJson("{\"feedItems\":[{\"feedType\":\"YouTubeVideo\",\"id\":\"StudioStart1\",\"title\":\"Sketch Series\",\"titleKey\":\"\",\"description\":\"Following along with bite-sized video tutorials that break down complex principles and introduce key topics\",\"descriptionKey\":\"\",\"order\":0,\"thumbnails\":{\"default\":{\"url\":\"/assets/feeds/sketch.webp\"},\"studio\":{\"url\":\"/assets/feeds/sketch.png\"}},\"url\":\"https://www.youtube.com/playlist?list=PLMneGxZNs3ZawdQ3Y5bjCRHM75fDJydv9\",\"placeId\":\"\",\"universeId\":\"\",\"duration\":\"\",\"difficulty\":\"\",\"categories\":[],\"badge\":\"\",\"authorAvatarUrl\":\"/assets/feeds/robloxYoutubeAvatar.webp\",\"authorName\":\"RobloxLearn\",\"authorUserId\":\"@RobloxLearn\",\"createdAtUtcTime\":\"\",\"startedAtUtcTime\":\"\",\"endedAtUtcTime\":\"\",\"likeCount\":0,\"commentCount\":0},{\"feedType\":\"Article\",\"id\":\"StudioStart2\",\"title\":\"Tutorials\",\"titleKey\":\"\",\"description\":\"Get to grips with the fundamentials of Studio and learn how to create complete experiences\",\"descriptionKey\":\"\",\"order\":0,\"thumbnails\":{\"default\":{\"url\":\"/assets/feeds/tutorials.webp\"},\"studio\":{\"url\":\"/assets/feeds/tutorials.png\"}},\"url\":\"https://create.roblox.com/docs/en-us/tutorials?utm_source=studio&utm_content=start_page\",\"placeId\":\"\",\"universeId\":\"\",\"duration\":\"\",\"difficulty\":\"\",\"categories\":[],\"badge\":\"\",\"authorAvatarUrl\":\"\",\"authorName\":\"\",\"authorUserId\":\"\",\"createdAtUtcTime\":\"\",\"startedAtUtcTime\":\"\",\"endedAtUtcTime\":\"\",\"likeCount\":0,\"commentCount\":0},{\"feedType\":\"Article\",\"id\":\"StudioStart3\",\"title\":\"Roblox Principles\",\"titleKey\":\"\",\"description\":\"Discover the structure of Roblox experiences, and what happens when a user plays your creation\",\"descriptionKey\":\"\",\"order\":0,\"thumbnails\":{\"default\":{\"url\":\"/assets/feeds/datamodel.webp\"},\"studio\":{\"url\":\"/assets/feeds/datamodel.png\"}},\"url\":\"https://create.roblox.com/docs/en-us/creation#experiences?utm_source=studio&utm_content=start_page\",\"placeId\":\"\",\"universeId\":\"\",\"duration\":\"\",\"difficulty\":\"\",\"categories\":[],\"badge\":\"\",\"authorAvatarUrl\":\"\",\"authorName\":\"\",\"authorUserId\":\"\",\"createdAtUtcTime\":\"\",\"startedAtUtcTime\":\"\",\"endedAtUtcTime\":\"\",\"likeCount\":0,\"commentCount\":0},{\"feedType\":\"Article\",\"id\":\"StudioStart4\",\"title\":\"Avatar Documentation\",\"titleKey\":\"\",\"description\":\"Create clothing, accessories, bodies and heads, and discover how to use Roblox's rich avatar features\",\"descriptionKey\":\"\",\"order\":0,\"thumbnails\":{\"default\":{\"url\":\"/assets/feeds/avatar.webp\"},\"studio\":{\"url\":\"/assets/feeds/avatar.png\"}},\"url\":\"https://create.roblox.com/docs/avatar?utm_source=studio&utm_content=start_page\",\"placeId\":\"\",\"universeId\":\"\",\"duration\":\"\",\"difficulty\":\"\",\"categories\":[],\"badge\":\"\",\"authorAvatarUrl\":\"\",\"authorName\":\"\",\"authorUserId\":\"\",\"createdAtUtcTime\":\"\",\"startedAtUtcTime\":\"\",\"endedAtUtcTime\":\"\",\"likeCount\":0,\"commentCount\":0},{\"feedType\":\"Article\",\"id\":\"StudioStart5\",\"title\":\"Engine Documentation\",\"titleKey\":\"\",\"description\":\"Go deeper into Studio features with comprehensive guides, samples, and API references\",\"descriptionKey\":\"\",\"order\":0,\"thumbnails\":{\"default\":{\"url\":\"/assets/feeds/engine.webp\"},\"studio\":{\"url\":\"/assets/feeds/engine.png\"}},\"url\":\"https://create.roblox.com/docs/en-us/platform?utm_source=studioe&utm_content=start_page\",\"placeId\":\"\",\"universeId\":\"\",\"duration\":\"\",\"difficulty\":\"\",\"categories\":[],\"badge\":\"\",\"authorAvatarUrl\":\"\",\"authorName\":\"\",\"authorUserId\":\"\",\"createdAtUtcTime\":\"\",\"startedAtUtcTime\":\"\",\"endedAtUtcTime\":\"\",\"likeCount\":0,\"commentCount\":0},{\"feedType\":\"Article\",\"id\":\"StudioStart6\",\"title\":\"Creator Hub\",\"titleKey\":\"\",\"description\":\"Promote and monitor your experiences, and connect with the Roblox Creator community\",\"descriptionKey\":\"\",\"order\":0,\"thumbnails\":{\"default\":{\"url\":\"/assets/feeds/creator_hub.webp\"},\"studio\":{\"url\":\"/assets/feeds/creator_hub.png\"}},\"url\":\"https://create.roblox.com/?utm_source=studio&utm_content=start_page\",\"placeId\":\"\",\"universeId\":\"\",\"duration\":\"\",\"difficulty\":\"\",\"categories\":[],\"badge\":\"\",\"authorAvatarUrl\":\"\",\"authorName\":\"\",\"authorUserId\":\"\",\"createdAtUtcTime\":\"\",\"startedAtUtcTime\":\"\",\"endedAtUtcTime\":\"\",\"likeCount\":0,\"commentCount\":0}],\"meta\":{\"currentPage\":1,\"lastPage\":1,\"perPage\":6,\"total\":6}}");
